 ...
 * @author Vicky Wang
 */
public class ContainerSelectionPO extends DialogPO implements HookConfigurationWizard, ProjectWizard
{

    private TreePO _pathTree;

    public ContainerSelectionPO( SWTBot bot )
    {
        this( bot, TEXT_BLANK );
    }

    public ContainerSelectionPO( SWTBot bot, String title )
    {
