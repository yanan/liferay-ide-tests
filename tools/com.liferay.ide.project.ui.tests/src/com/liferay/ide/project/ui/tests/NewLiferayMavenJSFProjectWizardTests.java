    ...
    implements NewLiferayJSFProjectWizard
{
    ...
    public void createMavenJSFStandardProject()
    {
        ...
        newLiferayJSFProject( projectName, TEXT_BUILD_FRAMEWORK_MAVEN, MENU_JSF_STANDARD, TEXT_BLANK );
    ...
    public void createMavenLiferayFacesAlloyProject()
    {
        ...
        newLiferayJSFProject( projectName, TEXT_BUILD_FRAMEWORK_MAVEN, MENU_LIFERAY_FACES_ALLOY, TEXT_BLANK );
    ...
    public void createMavenICEFacesProject()
    {
        ...
        newLiferayJSFProject( projectName, TEXT_BUILD_FRAMEWORK_MAVEN, MENU_ICEFACES, TEXT_BLANK );
    ...
    public void createMavenPrimeFacesProject()
    {
        ...
        newLiferayJSFProject( projectName, TEXT_BUILD_FRAMEWORK_MAVEN, MENU_PRIMEFACES, TEXT_BLANK );
    ...
    public void createMavenRichFacesProject()
    {
        ...
        newLiferayJSFProject( projectName, TEXT_BUILD_FRAMEWORK_MAVEN, MENU_RICHFFACES, TEXT_BLANK );
